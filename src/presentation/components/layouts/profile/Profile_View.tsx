...
export const Profile_View = () => {
  ...
  useEffect(() => {
    ...
    setInterval(() => {
      setCurrentHour(DateTime.local().toLocaleString({
        hour: 'numeric',
        minute: 'numeric',
        hour12: true 
      }));
    ...
    <div  className='ml-4 mt-4 w-[70vw] bg-white rounded-xl h-[20vh] max-h-[30vh] flex items-center '>
        ...
        <div className=''>
          ...
          <div className='flex h-[100%]  flex-wrap'>
           <ProfileItem title='Ubicacion: Barrio Alegria' icon='fa-solid fa-location-dot'/>
           <ProfileItem title='DNI: 1234567890' icon='fa-regular fa-id-card'/>
           <ProfileItem title='Correo Electronico: luisdejesus200122@gmail.com' icon='fa-regular fa-envelope'/>
          </div>
        </div>
    </div>
